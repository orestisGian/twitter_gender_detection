...
searchObj = re.search( r'(.+)\.json', ground_truth, re.M|re.I)
if searchObj:
...
#search if csv file already exists.if it exists we grab the parsed users' IDs and continue with the rest
